...
def madlib1(): 
    ...
    verb = ('enter a verb in ing form : ')
    food = input('food name : ')
    print('say ' + food + ', the photographer said as the camera flashed! ' + name + 
          ' and I had gone to ' + place + 'to get our photos taken on my birthday. The first photo we really wanted was a picture of us dressed as '
           + animals + 'pretending to be a ' + profession + '. when we saw the second photo, it was exactly what I wanted. We both looked lick '
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' + adjactive + 'butterfly with ' +
           color + 'splocthes that looked like' + thing + ' .I flew to ' + 
           place + ' with my bestfriend and' + person + ' who was a ' +
            adjactive1 + '' + insect + ' .We ate some ' + food + 
...
def madlib3():
    ...
    place = input('enter a place name : ')
    person = input('enter a person name : ')
    adjactive = input('enter a adjactive : ')
    food = input('enter a food name : ')
    ...
    print('Today we picked apple from ' + person + "'s Orchard. I had no idea there were so many different varieties of apples. I ate " +
           color + ' apples straight off the tree that tested like ' + foods + '. Then there was a ' + adjactive +
...
root.mainloop() # 윈도우창을 윈도우가 종료될때까지 실행한다